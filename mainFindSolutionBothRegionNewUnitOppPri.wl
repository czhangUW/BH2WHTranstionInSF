...
preciseND=50;
chopdelta=20;
immiriziValue=10^-1;Delta=1(*Delta=immirizi kappa hbar*);
alphaValue=2Sqrt[3]immiriziValue^2 Delta;
M= 200000;rb=(alphaValue M/2)^(1/3);
...
\[Theta]1=(rangleTheta1//Last)-10^-5;
\[Theta]3=(rangleTheta3//Last)-10^-6;
...
(***SpecialHere***)
representingDihedralFromCurvedGeo=-#&/@representingDihedralFromCurvedGeo;
(******)
...
scaleDphi0=10^-4;
If[!FileExistsQ["./results/solutionNewK0.wl"],findSolutions[curvedSFData,sl2cRules4CC,spinorRules4CC,areafRule,allvariablesp,rule4Bp,dihedralFromCurvedGeo,scaleDphi0,{},immiriziValue,"./results/solutionNewK0",False,{40,20,20}]
];
...
otherInitial[i]//Normal,immiriziValue,fileName[[i]],False,{40,20,20}]//AbsoluteTiming;Print[timing]),{i,1,Length[whichToCalculate]}]
]
...
findSolutionsWithCondition[curvedSFData,sl2cRules4CC,spinorRules4CC,areafRule,allvariablesp,rule4Bp,dihedralFromCurvedGeo,toBeCalculated[[i]],initial,immiriziValue,fileName[[i]],{10,10^-15},{40,20,20}]//AbsoluteTiming;
Print[timing];
